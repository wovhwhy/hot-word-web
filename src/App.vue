<!-- <template>
 <trunk v-if=!($route.meta.Login @login="islogin" :islogin="islogin"></trunk> 
...
<template>
  <div class="heard">
    ...
    <div class="heardmenu">
      ...
      <el-button v-if="userId === null" type="danger"  color="rgb(237, 147, 162)" @click="gosign" >登录/注册</el-button>
      <el-button v-if="userId !== null" type="danger"  color="rgb(237, 147, 162)" @click="tui" >退出</el-button>
    </div>
  </div>

  <div class="main">
    <!-- <router-view @send-id="sandId"></router-view> -->
